...
if [ "$SLURM_ARRAY_TASK_ID" -eq 0 ]; then
    ...
    python -u /scratch/gpfs/GVECCHI/el2358/ACE2_1000/$year/tc_tracking/code/data_file_preprocess_${year}.py \
        /scratch/gpfs/GVECCHI/el2358/ACE2_1000/$year/output/output_dir_${year}_1_100

elif [ "$SLURM_ARRAY_TASK_ID" -eq 1 ]; then

    python /scratch/gpfs/GVECCHI/el2358/ACE2_1000/$year/tc_tracking/code/data_file_preprocess_${year}.py \
